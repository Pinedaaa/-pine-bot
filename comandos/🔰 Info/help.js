        ...
        if (args[0]) {
            ...
            if (comando) {
                let embed = new Discord.EmbedBuilder()
                    ...
                    .setFooter({ text: `© desarrollado por Pineda#5562 | 2022`, iconURL: `https://cdn.discordapp.com/avatars/282942681980862474/7ff4f4ae92af5feb0d258a71cdb0b060.png?size=4096` })
            ...
            .setColor(client.color)
            .setDescription(`Bot Multifuncional en desarrollo por \`Pineda#5562\``)
            ...
            .addFields([{name: `📈 **__ESTADÍSTICAS__**`, value: `⚙ **${client.commands.size} Comandos**\n📁 en **${client.guilds.cache.size} Servidores**\n📶 **\`${client.ws.ping}ms\` Ping**\n👤 desarrollado por **[Pineda#5562](https://discord.gg/y5naapZe7B)**`}], )
            .addFields([{name: `✍ **__YOUTUBE PINEDA__**`, value: `[\`Pinedita!\`](https://www.youtube.com/channel/UCM7UO5zsapk4lrGjcrJAiVQ)`}], )
            .setThumbnail(message.guild.iconURL({ dynamic: true }))
            .setFooter({ text: `Página 1 / ${categorias.length+1}\n© desarrollado por Pineda#5562 | 2022`, iconURL: `https://cdn.discordapp.com/avatars/971541182394040320/26b5e17ed174a445d80b882d9c3d637f.webp?size=4096` })
            ...
            collector.on("collect", async (interaccion) => {
                if (interaccion.isButton()) {
                    ...
                    for (const seleccionado of interaccion.values) {
                        ...
                        .setThumbnail(message.guild.iconURL({ dynamic: true }))
                        .setDescription(comandos_de_categoria.length >= 1 ? `>>> *${comandos_de_categoria.map(comando => `\`${comando.replace(/.js/, "")}\``).join(" - ")}*` : `>>> *Todavía no hay comandos en esta categoría...*`)
                        .setFooter({text: `© desarrollado por Pineda#5562 | 2022`, iconURL: `https://cdn.discordapp.com/avatars/971541182394040320/26b5e17ed174a445d80b882d9c3d637f.webp?size=4096` })
